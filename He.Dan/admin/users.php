...
if(isset($_GET['action'])) {
	switch ($_GET['action']) {
		case "update":
			...
			break;
		case "create":
			$empty_users->name = $_POST['user-name'];
			$empty_users->type = $_POST['user-type'];
			$empty_users->email = $_POST['user-email'];
			$empty_users->classes = explode(", ", $_POST['user-classes']);
...
echo <<<HTML
<nav class="display-inline-flex">
	<ul>
	<div class=""><a href="{$_SERVER['PHP_SELF']}">Back</a></div>
